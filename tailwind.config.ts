  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--aqua) / 0.3)" },
          "50%": { boxShadow: "0 0 40px hsl(var(--aqua) / 0.5)" },
        },
        "ripple": {
      ...
      animation: {
        ...
        "pressure-pulse": "pressure-pulse 4s ease-in-out infinite",
      },
    },
  },
